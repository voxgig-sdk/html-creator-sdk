...
type HtmlDocumentEntity struct {
	name    string
	client  *core.HtmlCreatorSDK
...
func NewHtmlDocumentEntity(client *core.HtmlCreatorSDK, entopts map[string]any) *HtmlDocumentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HtmlDocumentEntity) GetName() string { return e.name }
...
func (e *HtmlDocumentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HtmlDocumentEntity) Deleted() bool {
	return e.deleted
}


func (e *HtmlDocumentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHtmlDocumentEntity(e.client, opts)
}

func (e *HtmlDocumentEntity) Data(args ...any) any {
...
func (e *HtmlDocumentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HtmlDocument; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HtmlDocumentEntity) DataTyped(data ...HtmlDocument) HtmlDocument {
	if len(data) > 0 {
		return typedFrom[HtmlDocument](e.Data(asMap(data[0])))
	}
	return typedFrom[HtmlDocument](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HtmlDocument (all fields
// optional at the wire level).
func (e *HtmlDocumentEntity) MatchTyped(match ...HtmlDocument) HtmlDocument {
	if len(match) > 0 {
		return typedFrom[HtmlDocument](e.Match(asMap(match[0])))
	}
	return typedFrom[HtmlDocument](e.Match())
}
...
func (e *HtmlDocumentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HtmlDocumentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *HtmlDocumentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *HtmlDocumentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HtmlDocumentCreateData and returns an HtmlDocument. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *HtmlDocumentEntity) CreateTyped(reqdata HtmlDocumentCreateData, ctrl map[string]any) (HtmlDocument, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return HtmlDocument{}, err
	}
	return typedFrom[HtmlDocument](res), nil
}



func (e *HtmlDocumentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HtmlDocumentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HtmlDocumentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
