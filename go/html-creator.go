...
// instead of `sdk.NewHtmlCreatorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HtmlCreatorSDK  { return NewHtmlCreatorSDK(nil) }
func Test() *HtmlCreatorSDK { return TestSDK(nil, nil) }
