...
func registerSDKWords(r *eng.Registry, client *sdk.HtmlCreatorSDK) {
...
func runOp(client *sdk.HtmlCreatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
