...
Results: HTML document created successfully.
...
| --- | --- | --- | --- |
| HtmlDocument | `create` | `POST /html/create` | Required |

## Connect to the API

- Production server: `https://api.html-creator.com/v1`
...
- `html-creator_list`: List records for an entity. No active entity supports this operation.
- `html-creator_load`: Load one record for an entity. No active entity supports this operation.
