...
require_relative 'HtmlCreator_types'
...
class HtmlCreatorSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = HtmlCreatorHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = HtmlCreatorHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, HtmlCreatorFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    HtmlCreatorUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = HtmlCreatorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = HtmlCreatorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = HtmlCreatorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = HtmlCreatorHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = HtmlCreatorError.new(
        "graphql_error", "HtmlCreatorSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = HtmlCreatorSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
