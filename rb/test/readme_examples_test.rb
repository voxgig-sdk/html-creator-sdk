...
#      offline in seeded test mode (HtmlCreatorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HtmlCreator_sdk.rb")
  SDK_CLASS = "HtmlCreatorSDK"
