# HtmlCreator Ruby SDK



The Ruby SDK for the HtmlCreator API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `HtmlCreatorError` (a `StandardError` subclass), so wrap
...
```
rb/
├── HtmlCreator_sdk.rb       -- Main SDK module
