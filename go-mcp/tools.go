...
type Args struct {
	Entity string         `json:"entity" jsonschema:"html_document"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HtmlCreatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "html-creator_list",
		Description: "List records from HtmlCreator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "html-creator_load",
		Description: "Load a single record from HtmlCreator. " +
...
func runOp(client *sdk.HtmlCreatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HtmlCreatorSDK, name string) (sdk.HtmlCreatorEntity, error) {
	switch strings.ToLower(name) {
	case "html_document":
		return client.HtmlDocument(nil), nil
