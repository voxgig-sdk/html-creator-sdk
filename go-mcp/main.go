// Command HtmlCreator-mcp is an MCP server exposing the HtmlCreator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HtmlCreator_list  — list records of an entity
//	HtmlCreator_load  — load a single record of an entity
//
