...
function runner.env_override(m)
  local live = runner.getenv("HTML_CREATOR_TEST_LIVE")
  local override = runner.getenv("HTML_CREATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HTML_CREATOR_TEST_EXPLAIN")
