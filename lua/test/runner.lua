...
function runner.env_override(m)
  local live = runner.getenv("HTMLCREATOR_TEST_LIVE")
  local override = runner.getenv("HTMLCREATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HTMLCREATOR_TEST_EXPLAIN")
