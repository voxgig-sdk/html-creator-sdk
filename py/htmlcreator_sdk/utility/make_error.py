...
def make_error_util(ctx, err):
    if ctx is None:
        from htmlcreator_sdk.core.context import HtmlCreatorContext
        ctx = HtmlCreatorContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, HtmlCreatorError):
        errmsg = err.msg
    ...
    sdk_err = HtmlCreatorError("", msg, ctx)
