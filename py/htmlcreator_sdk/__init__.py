...
from htmlcreator_sdk.utility import register

# Load features
from htmlcreator_sdk.feature.base_feature import HtmlCreatorBaseFeature
from htmlcreator_sdk.features import _has_feature, _make_feature
...
class HtmlCreatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HtmlCreatorUtility()
        self._utility = utility

        from htmlcreator_sdk.config import shared_config
    ...
    def get_utility(self):
        return HtmlCreatorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HtmlCreatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def HtmlDocument(self, data=None) -> "HtmlDocumentEntity":
        ...
        from htmlcreator_sdk.entity.html_document_entity import HtmlDocumentEntity
