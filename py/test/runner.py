...
class HtmlCreatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HtmlCreatorTestRunner.getenv("HTMLCREATOR_TEST_LIVE")
        override = HtmlCreatorTestRunner.getenv("HTMLCREATOR_TEST_OVERRIDE")
        ...
        explain = HtmlCreatorTestRunner.getenv("HTMLCREATOR_TEST_EXPLAIN")
