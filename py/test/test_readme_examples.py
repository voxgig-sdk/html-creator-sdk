# HtmlCreator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HtmlCreatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HtmlCreatorSDK(...) and HtmlCreatorSDK.test(...) become
#      HtmlCreatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "htmlcreator_sdk"
_SDK_CLASS = "HtmlCreatorSDK"
