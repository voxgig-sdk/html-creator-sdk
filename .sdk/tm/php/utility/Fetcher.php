...
// HtmlCreator SDK utility: fetcher

class HtmlCreatorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HtmlCreatorSDK/1.0)';
    ...
    public static function call(HtmlCreatorContext $ctx, string $fullurl, array $fetchdef): array
    {
