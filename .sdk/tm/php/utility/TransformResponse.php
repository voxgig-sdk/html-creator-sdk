...
// HtmlCreator SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HtmlCreatorTransformResponse
{
    public static function call(HtmlCreatorContext $ctx): mixed
    {
        ...
        $transform = HtmlCreatorHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
