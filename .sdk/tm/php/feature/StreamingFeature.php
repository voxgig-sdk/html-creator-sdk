...
// HtmlCreator SDK streaming feature
...
class HtmlCreatorStreamingFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _iterate(HtmlCreatorResult $result): \Generator
    {
    ...
    private function _streamable(HtmlCreatorContext $ctx): bool
    {
