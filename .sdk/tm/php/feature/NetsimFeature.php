...
// HtmlCreator SDK netsim feature
...
class HtmlCreatorNetsimFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _simulate(HtmlCreatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HtmlCreatorContext $ctx, array $applied): void
    {
        $client = $this->client;
