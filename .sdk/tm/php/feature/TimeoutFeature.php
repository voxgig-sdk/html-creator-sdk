...
// HtmlCreator SDK timeout feature
...
class HtmlCreatorTimeoutFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _with_timeout(HtmlCreatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HtmlCreatorContext $_ctx, float $ms): void
    {
        $client = $this->client;
