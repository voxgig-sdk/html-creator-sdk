...
// HtmlCreator SDK ratelimit feature
...
class HtmlCreatorRatelimitFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _acquire(HtmlCreatorContext $ctx): void
    {
    ...
    private function _track(HtmlCreatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
