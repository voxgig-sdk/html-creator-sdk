...
// HtmlCreator SDK metrics feature
...
class HtmlCreatorMetricsFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _record(HtmlCreatorContext $ctx, bool $ok): void
    {
