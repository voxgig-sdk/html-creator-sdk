...
class HtmlCreatorProxyFeature extends HtmlCreatorBaseFeature
{
    ...
    public function init(HtmlCreatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HtmlCreatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
