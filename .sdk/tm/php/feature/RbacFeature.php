...
class HtmlCreatorRbacFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _required(HtmlCreatorContext $ctx): ?string
    {
    ...
    private function _reject(HtmlCreatorContext $ctx, string $required): void
    {
    ...
    private function _track(HtmlCreatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
