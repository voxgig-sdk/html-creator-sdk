...
// HtmlCreator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HtmlCreatorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HtmlCreatorOmni::structfix($now, Struct::undef()))
                        !== json_encode(HtmlCreatorOmni::structfix($val, Struct::undef()))) {
