...
class HtmlCreatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HtmlCreatorTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = HtmlCreatorTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = HtmlCreatorTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
