...
class HtmlCreatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HtmlCreatorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HtmlCreatorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HtmlCreatorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
