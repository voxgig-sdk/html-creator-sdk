...
|---|---|---|
| `ts/` | @voxgig-sdk/html-creator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/html-creator-sdk \
      --repository voxgig-sdk/html-creator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/html-creator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/html-creator-sdk --id=<id>` removes it.
