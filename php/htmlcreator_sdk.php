...
class HtmlCreatorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HtmlCreatorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HtmlCreatorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HtmlCreatorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HtmlCreatorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HtmlCreatorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HtmlCreatorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HtmlCreatorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HtmlCreatorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HtmlCreatorError($op . "_allow",
                "HtmlCreatorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HtmlCreatorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HtmlCreatorError("graphql_error",
                "HtmlCreatorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function HtmlDocument($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_html_document === null) {
                $this->_html_document = new HtmlDocumentEntity($this, null);
            }
            return $this->_html_document;
        }
        return new HtmlDocumentEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HtmlCreatorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
