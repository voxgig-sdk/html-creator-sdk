...
// HtmlCreator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HtmlCreatorMakeRequest
{
    public static function call(HtmlCreatorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HtmlCreatorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HtmlCreatorResponse($fetched);
        } else {
