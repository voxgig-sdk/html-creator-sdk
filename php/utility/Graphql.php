...
// HtmlCreator SDK utility: graphql
//
...
class HtmlCreatorGraphql
{
    ...
    // equivalent.
    public static function body(HtmlCreatorContext $ctx): mixed
    {
    ...
    public static function errors(HtmlCreatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
