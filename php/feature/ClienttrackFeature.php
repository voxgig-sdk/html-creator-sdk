...
// HtmlCreator SDK clienttrack feature
...
class HtmlCreatorClienttrackFeature extends HtmlCreatorBaseFeature
{
    ...
    public function PostConstruct(HtmlCreatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HtmlCreator-SDK';
