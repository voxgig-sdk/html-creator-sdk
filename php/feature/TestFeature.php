...
// HtmlCreator SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HtmlCreatorTestFeature extends HtmlCreatorBaseFeature
{
    ...
    public function init(HtmlCreatorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HtmlCreatorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HtmlCreatorParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HtmlCreatorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HtmlCreatorContext $ctx, $op, $args): array
    {
