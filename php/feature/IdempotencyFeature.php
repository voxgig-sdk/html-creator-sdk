...
// HtmlCreator SDK idempotency feature
...
class HtmlCreatorIdempotencyFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _mutating(HtmlCreatorContext $ctx): bool
    {
