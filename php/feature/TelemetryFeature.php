...
// HtmlCreator SDK telemetry feature
...
class HtmlCreatorTelemetryFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _close(HtmlCreatorContext $ctx, bool $ok): void
    {
