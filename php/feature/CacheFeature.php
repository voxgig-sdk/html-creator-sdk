...
class HtmlCreatorCacheFeature extends HtmlCreatorBaseFeature
{
    ...
    private function _through(HtmlCreatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
