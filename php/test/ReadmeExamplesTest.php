...
// HtmlCreator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HtmlCreatorSDK::test)
...
{
    private const SDK_CLASS = 'HtmlCreatorSDK';
    ...
    private const SDK_BASE = 'htmlcreator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../htmlcreator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
