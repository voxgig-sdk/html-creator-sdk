...
{
    private static function utility(): HtmlCreatorUtility
    {
        return new HtmlCreatorUtility();
    }
    ...
    private static function ctx(array $over = []): HtmlCreatorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HtmlCreatorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HtmlCreatorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HtmlCreatorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HtmlCreatorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HtmlCreatorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HtmlCreatorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HtmlCreatorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HtmlCreatorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HtmlCreatorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HtmlCreatorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HtmlCreatorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HtmlCreatorResponse([]),
            'result' => new HtmlCreatorResult([]),
        ]);
        [, $err] = HtmlCreatorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec([]),
            'response' => null,
            'result' => new HtmlCreatorResult([]),
        ]);
        [, $err] = HtmlCreatorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec(['step' => 's']),
            'response' => new HtmlCreatorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HtmlCreatorResult([]),
        ]);
        [, $err] = HtmlCreatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec(['step' => 's']),
            'response' => new HtmlCreatorResponse(self::resp(200, ['v' => 1])),
            'result' => new HtmlCreatorResult([]),
        ]);
        [, $err] = HtmlCreatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec(['step' => 's']),
            'response' => new HtmlCreatorResponse(self::resp(200, ['v' => 2])),
            'result' => new HtmlCreatorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HtmlCreatorMakeResponse::call($ctx);
    ...
    {
        $preset = new HtmlCreatorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec([]),
            'response' => new HtmlCreatorResponse([]),
            'result' => new HtmlCreatorResult([]),
        ...
        [$got, $err] = HtmlCreatorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HtmlCreatorResult([])]);
        [, $err] = HtmlCreatorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HtmlCreatorSpec([]), 'result' => null]);
        [, $err] = HtmlCreatorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HtmlCreatorSpec(['step' => 's']),
            'result' => new HtmlCreatorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HtmlCreatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HtmlCreatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HtmlCreatorSpec(['step' => 's']),
            'result' => new HtmlCreatorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HtmlCreatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HtmlCreatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HtmlCreatorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HtmlCreatorSpec([]),
            'result' => new HtmlCreatorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HtmlCreatorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HtmlCreatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HtmlCreatorError('boom', 'boom');
        $utility->fetcher = function (HtmlCreatorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HtmlCreatorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HtmlCreatorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HtmlCreatorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HtmlCreatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HtmlCreatorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HtmlCreatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HtmlCreatorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HtmlCreatorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HtmlCreatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HtmlCreatorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HtmlCreatorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HtmlCreatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HtmlCreatorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HtmlCreatorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HtmlCreatorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HtmlCreatorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HtmlCreatorResult(['ok' => false])]);
        $this->expectException(HtmlCreatorError::class);
        HtmlCreatorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HtmlCreatorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HtmlCreatorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HtmlCreatorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HtmlCreatorBaseFeature();
        $b = new HtmlCreatorBaseFeature();
        HtmlCreatorFeatureAdd::call($ctx, $a);
        HtmlCreatorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HtmlCreatorBaseFeature
    {
        $f = new HtmlCreatorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HtmlCreatorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HtmlCreatorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HtmlCreatorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HtmlCreatorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HtmlCreatorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HtmlCreatorResponse(['headers' => null]),
            'result' => new HtmlCreatorResult([]),
        ]);
        HtmlCreatorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HtmlCreatorResultBody::call($ctx);
