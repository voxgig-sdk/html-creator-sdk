...
```bash
cd go-mcp && go build -o html-creator-mcp .
```
...
```json
{
  "mcpServers": {
    "html-creator": {
      "command": "/abs/path/to/html-creator-mcp"
    }
  }
}
```
...
Generated from the HTML Creator API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
